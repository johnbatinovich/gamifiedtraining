...
class UserManager {
    constructor() {
        this.storageKey = 'd365_users';
        this.currentUserKey = 'd365_current_user';
        this.progressKey = 'd365_user_progress';
        this.adminKey = 'd365_admin_users';
